...
import StudentCourseDetails from './Pages/Dashboard/StudentDashboard/StudentCourseDetails'
...
import TeacherCourseDetails from './Pages/Dashboard/TeacherDashboard/TeacherCourseDetails'
  ...
  createRoutesFromElements(
    ...
    <Route path='/' element={<Layout/>}>
      ...
      <Route path='/Student/Dashboard/:ID' element={<StudentLayout/>}>
        ...
        <Route path='/Student/Dashboard/:ID/CourseDetails' element={<StudentCourseDetails/>}/>
      </Route>
      <Route path='/Teacher/Dashboard/:ID' element={<TeacherLayout/>}>
        ...
        <Route path='/Teacher/Dashboard/:ID/CourseDetails' element={<TeacherCourseDetails/>}/>
      </Route>
