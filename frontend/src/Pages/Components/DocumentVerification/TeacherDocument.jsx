  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        // Make sure we're correctly setting the data object with the API response
        // The API likely returns data in a nested structure
        setData(userData.data || userData);

        // Update form data after receiving response
        setFormData({
          Phone: userData.data?.Phone || userData.Phone || "",
          Address: userData.data?.Address || userData.Address || "",
          Experience: userData.data?.Experience || userData.Experience || "",
          SecondarySchool: userData.data?.SecondarySchool || userData.SecondarySchool || "",
          HigherSchool: userData.data?.HigherSchool || userData.HigherSchool || "",
          SecondaryMarks: userData.data?.SecondaryMarks || userData.SecondaryMarks || "",
          HigherMarks: userData.data?.HigherMarks || userData.HigherMarks || "",
          UGcollege: userData.data?.UGcollege || userData.UGcollege || "",
          UGmarks: userData.data?.UGmarks || userData.UGmarks || "",
          PGcollege: userData.data?.PGcollege || userData.PGcollege || "",
          PGmarks: userData.data?.PGmarks || userData.PGmarks || "",
          Aadhaar: null,
          Secondary: null,
          Higher: null,
          UG: null,
